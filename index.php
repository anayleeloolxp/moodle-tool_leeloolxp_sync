...
if (isset($reqsyncategory) && $reqsyncategory == '1') {
    ...
    if (!empty($categorydata)) {
        ...
        $curl->post($url, $post, $options); // die;
    ...
    foreach ($alldata as $key => $value) {
        ...
        if (!empty($tempdata[3])) {
            ...
            FROM {tag_instance}
                ...
                where {tag_instance}.itemid = ?", [$itemidd]);
        }
        ...
        // echo "<pre>";print_r($curl->post($url, $post, $options));die;
...
if (isset($reqresyncactivity)) {
    ...
    // echo "<pre>";print_r($activityid);die;
                    ...
                    foreach ($modulescourse as $coursemoduledetails) {
                        ...
                        if (!empty($modules)) {
                            foreach ($modules as $key => $value) {
                                ...
                                $moduledetail = $DB->get_records($tbll,
...
if (isset($reqcourseiddate) && !empty($reqcourseiddate)) {
    $courseidagain = $reqcourseiddate;
    ...
    $msg = get_string('datesychronizationed_success', 'tool_leeloolxp_sync');
}
                ...
                foreach ($courses as $courskey => $coursevalue) {
                    ...
                    if ($alreadysync) {
                        echo '<li><a href="' . parse_url($_SERVER["REQUEST_URI"],
                            ...
                            PHP_URL_PATH) . '?action=add&courseid=' . $coursevalue->id . '">
                        ...
                        echo '<li><a href="' . parse_url($_SERVER['REQUEST_URI'],
                            ...
                            PHP_URL_PATH) . '?resync=resync&courseid_resync=' . $coursevalue->id . '">
                                        ...
                                        foreach ($moduledetail as $key => $valuefinal) {
                                            ...
                                            if (isset($valuefinal->questionsperpage)) {
                                                $isquiz = $DB->get_record_sql(
                                                    "SELECT id FROM {tool_leeloolxp_sync} where activityid =  ? and is_quiz = '1' order by id desc limit 1", [$activityids->id]
                                                );
    ...
    <div class="dialog-modal-inn">
        ...
        <div id="dialog" >
            ...
            <div class="sure-btn">
                ...
                class="btn btn_yes_activityunsync" ><?php echo get_string('yessure', 'tool_leeloolxp_sync'); ?></button>
    ...
    <div class="dialog-modal-inn">
        ...
        <div id="dialog" >
            ...
            <div class="sure-btn">
                ...
                class="btn btn_yes_courseunsync" ><?php echo get_string('yessure', 'tool_leeloolxp_sync'); ?></button>
