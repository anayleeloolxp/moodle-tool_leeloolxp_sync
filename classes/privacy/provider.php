...
/**
 * Privacy Subsystem implementation for tool_leeloolxp_sync.
 *
...
namespace tool_leeloolxp_sync\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        ...
        $collection->add_external_location_link('leeloolxp_sync_client', $externalfields, 'privacy:metadata:leeloolxp_sync');
